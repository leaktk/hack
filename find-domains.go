...
var tlds = []string{
	...
	"autos", "aw", "aws", "ax", "axa", "az", "azure", "ba", "baby", "baidu",
	"banamex", "band", "bank", "bar", "barcelona", "barclaycard", "barclays",
	"barefoot", "bargains", "baseball", "basketball", "bauhaus", "bayern",
	"bb", "bbc", "bbt", "bbva", "bcg", "bcn", "bd", "be", "beats", "beauty",
	"beer", "berlin", "best", "bestbuy", "bet", "bf", "bg", "bh", "bharti",
	...
	"brother", "brussels", "bs", "bt", "build", "builders", "business", "buy",
	...
	"cba", "cbn", "cbre", "cc", "cd", "center", "ceo", "cern", "cf", "cfa",
	...
	"cw", "cx", "cy", "cymru", "cyou", "cz", "dad", "dance", "data", "date",
	...
	"et", "eu", "eurovision", "eus", "events", "exchange", "expert", "exposed",
	"express", "extraspace", "fage", "fail", "fairwinds", "faith", "family",
	"fan", "fans", "farm", "farmers", "fashion", "fast", "fedex", "feedback",
	...
	"fly", "fm", "fo", "foo", "food", "football", "ford", "forex", "forsale",
	...
	"mn", "mo", "mobi", "mobile", "moda", "moe", "moi", "mom", "monash",
	...
	"name", "navy", "nba", "nc", "ne", "nec", "net", "netbank", "netflix",
	"network", "neustar", "new", "news", "next", "nextdirect", "nexus", "nf",
	"nfl", "ng", "ngo", "nhk", "ni", "nico", "nike", "nikon", "ninja",
	"nissan", "nissay", "nl", "no", "nokia", "norton", "now", "nowruz",
	...
	"suzuki", "sv", "swatch", "swiss", "sx", "sy", "sydney", "systems", "sz",
	...
	"theater", "theatre", "tiaa", "tickets", "tienda", "tips", "tires",
	"tirol", "tj", "tjmaxx", "tjx", "tk", "tkmaxx", "tl", "tm", "tmall", "tn",
	"to", "today", "tokyo", "tools", "top", "toray", "toshiba", "total",
	...
	"youtube", "yt", "yun", "za", "zappos", "zara", "zero", "zip", "zm",
	"zone", "zuerich", "zw",
}
